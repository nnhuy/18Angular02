...
module.exports = "<div *ngIf=\"hero\">\n\n  <h2>{{hero.userName | uppercase}} Details</h2>\n  <div><span>age: </span>{{hero.age}}</div>\n  <div>\n    <label [class.is-age]=\"hero.age == 1\">name:\n      <input [(ngModel)]=\"hero.userName\" placeholder=\"name\"/>\n    </label>\n  </div>\n\n</div>"
...
module.exports = "<!-- <h2>{{hero.userName | uppercase}} Details</h2>\n<div><span>age: </span>{{hero.age}}</div>\n<div><span>name: </span>{{hero.userName}}</div>\n<div>{{timestamp | date: 'dd/mm/yyyy'}}</div>\n<div><input [(ngModel)]=\"hero.userName\"></div>\n<div><input ></div> -->\n<div *ngFor=\"let h of heroes; let i = index\">\n  <app-hero-detail [hero]=\"h\"></app-hero-detail>\n  \n</div>\n<!-- <div>Hero is click: {{heroIsClick?.userName}}</div>\n<div *ngIf=\"heroTest.userName\">{{heroTest.userName}}</div> -->\n<div>\n  Hero name: \n  <input [(ngModel)]=\"heroTest.userName\">\n</div>\n<div>\n  {{heroTest.userName}}\n</div>\n"
...
var HeroesComponent = /** @class */ (function () {
    function HeroesComponent(heroService) {
        ...
        this.timestamp = 1535027120000;
    }
    HeroesComponent.prototype.ngOnInit = function () {
        this.heroes = this.heroService.getHeroes();
    };
    HeroesComponent.prototype.heroClick = function (data) {
        console.log(data.userName);
        this.heroIsClick = data;
    };
...
module.exports = "<form #loginForm=\"ngForm\">\n  <div class=\"row mt-3\">\n    <div class=\"col-md-3\">Tên đăng nhập:</div>\n    <div class=\"col-md-9\">\n      <input [(ngModel)]=\"user.userName\" required name=\"userName\" class=\"form-control\" #username=\"ngModel\">\n      <div *ngIf=\"\"></div>\n    </div>\n  </div>\n  <div class=\"row mt-3\">\n    <div class=\"col-md-3\">Mật khẩu:</div>\n    <div class=\"col-md-9\">\n      <input [(ngModel)]=\"user.password\" required minlength=\"6\" name=\"password\" type=\"password\"\n        class=\"form-control\" #password=\"ngModel\">\n        <div>{{password.errors | json}}</div>\n        <div *ngIf=\"(password.dirty || password.touched) && password?.errors?.required\">Mật khẩu là bắt buộc</div>\n        <div *ngIf=\"(password.dirty || password.touched) && password?.errors?.minlength\">Mật khẩu phải nhiều hơn 6 ký tự</div>\n      </div>\n  </div>\n  <div class=\"row mt-3\">\n    <div class=\"col-md-3\">\n      Email:\n    </div>\n    <div class=\"col-md-9\">\n      <input class=\"form-control\" [(ngModel)]=\"email\" name=\"email\" #emailIp=\"ngModel\" pattern=\"[a-zA-Z0-9]+@[a-zA-Z0-9]*\" >\n      <div *ngIf=\"emailIp?.errors?.pattern\">Email không hợp lệ</div>\n    </div>\n  </div>\n  <div class=\"row mt-3\">\n    <input type=\"radio\" name=\"gender\" value=\"nam\" [(ngModel)]=\"gender\"> Nam\n    <input type=\"radio\" name=\"gender\" value=\"nu\" [(ngModel)]=\"gender\"> Nữ\n  </div>\n  <div *ngIf=\"gender == 'nam'\">Condition Nam</div>\n  <div *ngIf=\"gender == 'nu'\">Condition Nu</div>\n  <!-- <re-captcha siteKey=\"6Lcew24UAAAAANzf_secQ9QHVoPUEyuAfMVFSIdF\"></re-captcha> -->\n</form>\n<div>{{gender | json}}</div>\n"
...
var HEROES = [
    { age: 11, userName: 'Mr. Nice' },
    { age: 12, userName: 'Narco' },
    { age: 13, userName: 'Bombasto' },
    { age: 14, userName: 'Celeritas' },
    { age: 15, userName: 'Magneta' },
    { age: 16, userName: 'RubberMan' },
    { age: 17, userName: 'Dynama' },
    { age: 18, userName: 'Dr IQ' },
    { age: 19, userName: 'Magma' },
    { age: 20, userName: 'Tornado' }
];
...
module.exports = __webpack_require__(/*! /Users/huynguyennhat/Desktop/Angular1802/src/main.ts */"./src/main.ts");
